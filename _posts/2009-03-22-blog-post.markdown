...
categories: [java, error handling, pattern, factory method]
poster: {url: 'http://2.bp.blogspot.com/_MzPDIAgS1ow/ScY48e6QaTI/AAAAAAAAJ6Y/WkCsn9_myxU/s400/magican.jpg', width: '304px', height: '400px'}
